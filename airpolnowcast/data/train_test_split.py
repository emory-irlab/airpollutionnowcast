...
sys.path.append('.')
from airpolnowcast.data.utils import read_raw_data, select_years, get_city_output_path, outer_concatenate, read_query_from_file, create_folder_exist
...
def extract_file(config_path, merged_file_path, train_data_path, valid_data_path, test_data_path):
    ...
    create_folder_exist(os.path.dirname(train_data_path))
